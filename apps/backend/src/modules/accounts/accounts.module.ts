...
import { CREDIT_CARD_REPOSITORY } from './application/ports/credit-card.repository';
...
import {
  AccountModel,
  AccountSchema,
} from './infrastructure/persistence/account.schema';
import {
  CreditCardModel,
  CreditCardSchema,
...
@Module({
  ...
  exports: [ACCOUNT_REPOSITORY, CREDIT_CARD_REPOSITORY],
})
